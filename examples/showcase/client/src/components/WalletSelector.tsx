  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <strong>💡 Tip:</strong> If you have multiple wallets installed, please keep only the one
          you want to use enabled, and temporarily disable others to avoid conflicts.
        </div>
      </div>
    </div>
  );
